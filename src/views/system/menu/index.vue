  ...
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-container">
      ...
      >
        ...
        <el-table-column label="类型" align="center" width="80">
          <template #default="scope">
            <el-tag v-if="scope.row.type === MenuType.CATALOG" type="warning"
              >目录</el-tag
            >
    ...
    >
      ...
      >
        ...
        <el-form-item
          v-if="
            formData.type == MenuType.CATALOG || formData.type == MenuType.MENU
          "
          label="路由路径"
          prop="path"
        >
          <el-input
            v-if="formData.type == MenuType.CATALOG"
        ...
        >
          <el-input
            ...
            style="width: 95%"
          >
            <template v-if="formData.type == MenuType.MENU" #prepend
              >src/views/</template
            >
            <template v-if="formData.type == MenuType.MENU" #append
              >.vue</template
            >
          </el-input>
        </el-form-item>
        ...
        <el-form-item v-if="formData.type === MenuType.MENU" label="是否缓存">
        ...
        <el-form-item v-if="formData.type == MenuType.CATALOG" label="跳转路由">
